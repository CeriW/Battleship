...
function App() {
    var _a = react_1.useState(placeShips_1.placeShips()), computerShips = _a[0], setComputerShips = _a[1];
    var _b = react_1.useState(placeShips_1.placeShips()), userShips = _b[0], setUserShips = _b[1];
    var testHeatMapShips = placeShips_1.initialiseShipArray();
    // testHeatMapShips[1][1] = { name: 'test', hit: false };
    var heatMap = calculateHeatMap_1.calculateHeatMap(testHeatMapShips);
    // console.log(computerShips);
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { id: "boards" },
        ...
        react_1["default"].createElement("div", null,
            "Difficulty: ",
            ai_behaviour_1.difficultyClass),
